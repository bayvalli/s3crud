...
# Author: Burak Ayvalli
# Email: ayvalli@itu.edu.tr
...
from lib.s3controller import uploadfile, deletefile, md5
...
IGNORED_FILES = app.config['IGNORED_FILES']
DYNAMODB_TABLENAME = app.config['DYNAMODB_TABLENAME']
